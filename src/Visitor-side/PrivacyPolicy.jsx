...
const sections = [
  ...
  },
  {
    ...
    content: (
      <p className="mb-4 text-gray-700">
        TigerRoutes collects and processes student data solely to deliver
        personalized college program recommendations and career path guidance.
        The system analyzes data using a rule-based scoring engine and
        AI-assisted tools to generate insights aligned with each student’s
        interests, personality traits, academic performance, and SHS track.
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-3 text-gray-700">
          The system may collect the following categories of data:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          <li>
            <strong>Personal Profile Information:</strong> student name, SHS
            track/strand, current grade level.
          </li>
          <li>
            <strong>Academic Information:</strong> semester/subject grades
            (e.g., Math, Science, English) and overall general weighted average.
          </li>
          <li>
            <strong>Assessment Results:</strong> RIASEC interest profile and Big
            Five personality trait scores.
          </li>
          <li>
            <strong>System Interactions:</strong> feedback ratings, exploration
            logs, and usage metadata.
          </li>
          <li>
            <strong>Counselor Inputs:</strong> comments or insights provided by
            assigned counselors.
          </li>
        </ul>
        <p className="mt-3 text-sm text-gray-600">
          Note: Sensitive identifiers (student IDs, addresses, contact
          information, etc.) are not collected or stored unless explicitly
          authorized.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          <li>
            <strong>Rule-Based Scoring Engine:</strong> computes alignment
            scores and produces program recommendations.
          </li>
          <li>
            <strong>AI-Assisted Chat/Explanation:</strong> supports users in
            understanding results and next steps. AI is used to assist, not to
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-3 text-gray-700">
          Student data is stored securely using MySQL in an access-controlled
          environment. Security measures include encryption in transit (SSL) and
          restricted access to authorized personnel only.
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          <li>
            Access is limited to authorized development team members and
            assigned school counselors.
          </li>
          <li>Data is encrypted in transit and stored on secure servers.</li>
          <li>
            Administrative and technical safeguards are applied to protect
  ...
  },
  {
    ...
    content: (
      <p className="mb-3 text-gray-700">
        Student records are retained for up to four (4) years following
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-3 text-gray-700">
          TigerRoutes complies with the Data Privacy Act of 2012. Users have the
          following rights:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
        ...
        <p className="mt-3 text-gray-700">
          Upon registration and before submitting personal information or
          assessment results, students are required to provide informed consent.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-3 text-gray-700">
          TigerRoutes does not sell or trade personal data. Data may be shared
          only in the following limited circumstances:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
          <li>
            Authorized school administrators and guidance counselors for
            educational purposes.
          </li>
          <li>Research partners in anonymized and aggregated form.</li>
          <li>
            Service providers that support platform functionality under
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-3 text-gray-700">
          To request access, correction, deletion, or to raise privacy concerns,
          contact:
        </p>
        ...
        <p className="mt-3 text-sm text-gray-600">
          ...
          your request. Requests will be processed in accordance with applicable
          law.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <p className="mb-4 text-gray-700">
        This policy may be updated periodically. The effective date will be
        updated upon launch. Users will be notified of material changes.
      </p>
    ),
  },
];
